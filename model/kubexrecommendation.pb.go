...
// 	protoc        v6.32.0
// source: kubexrecommendation.proto
...
type Container struct {
	...
	RecommendedResources *RecommendedResources  `protobuf:"bytes,8,opt,name=recommended_resources,json=recommendedResources,proto3" json:"recommended_resources,omitempty"`
	AnalyzedOn           *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=analyzed_on,json=analyzedOn,proto3" json:"analyzed_on,omitempty"`
	CurrentResources     *RecommendedResources  `protobuf:"bytes,10,opt,name=current_resources,json=currentResources,proto3" json:"current_resources,omitempty"`
...
func (x *OwnerReference) Reset() {
	*x = OwnerReference{}
	mi := &file_kubexrecommendation_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OwnerReference) Descriptor() ([]byte, []int) {
	return file_kubexrecommendation_proto_rawDescGZIP(), []int{5}
}
...
const file_kubexrecommendation_proto_rawDesc = "" +
	...
	"\x15recommended_resources\x18\b \x01(\v2\x1b.model.RecommendedResourcesR\x14recommendedResources\x12;\n" +
	"\vanalyzed_on\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"analyzedOn\x12H\n" +
	"\x11current_resources\x18\n" +
	" \x01(\v2\x1b.model.RecommendedResourcesR\x10currentResources\x122\n" +
...
var file_kubexrecommendation_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
